  ...
  return (
    <BannerWrapper className='d-flex align-items-center justify-content-start' style = {{
      ...
      <div className='banner-content w-100 container text-white'>
        <div className='banner-badge text-uppercase'>All your games here!</div>
        <h1 className='banner-title text-uppercase'>The biggest gamer labary</h1>
        <p className='lead-text'>Step into the world of gaming with our gamer library! Join live gaming sessions, discover exclusive releases, unforgettable classics, and games for every style. Save your favorite games and build your own personal library. Explore fantastic worlds, conquer challenges, and dive into experiences that go beyond the screen. Here, every game is a new adventure waiting for you!</p>
